...
export const AttentionSlide = ({ description }: AttentionSlideProps) => {
  return (
    <motion.div
      ...
      className="slide-content-container bg-gradient-to-br from-yellow-500 to-orange-600 text-white rounded-2xl shadow-2xl p-12 w-full min-h-[600px] flex flex-col items-center justify-center relative overflow-hidden"
    >
      ...
      >
        <AlertTriangle size={500} strokeWidth={1.5} />
      </motion.div>
